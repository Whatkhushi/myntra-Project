        ...
        {generatedOutfits.length > 0 && (
          <div className="space-y-8">
            <div className="flex items-center justify-between">
              <h2 className="text-3xl font-bold text-gray-900">Your Curated Look ✨</h2>
              <Button 
                variant="outline" 
                onClick={handleGenerateClick}
                className="border-myntra-pink text-myntra-pink hover:bg-myntra-pink-light px-6 py-2 rounded-full font-semibold transition-all duration-200 hover:shadow-lg"
              >
                Generate New Look
              </Button>
            </div>
            ...
            <div className="bg-gradient-to-br from-white to-myntra-pink-light/10 rounded-2xl shadow-2xl border border-myntra-pink/20 p-8">
              <div className="text-center mb-6">
                <div className="inline-flex items-center gap-2 bg-myntra-pink/10 text-myntra-pink px-4 py-2 rounded-full text-sm font-semibold mb-4">
                  <Sparkles className="h-4 w-4" />
                  Curated by AI Stylist
                </div>
                <h3 className="text-2xl font-bold text-gray-900 mb-2">Perfect Match Found!</h3>
                <p className="text-gray-600">This combination was specially selected for you</p>
              </div>
